...
$(document).ready(function() {
  ...
  Highcharts.chart('bubble_graph', {
      ...
      title: {
          text: 'Índice Socioeconómico Promedio de Estudiantes'
      },
      xAxis: {
          categories: ic_prov,
  ...
  $(".map_cal").on("click", function(){
    ...
    Highcharts.chart('bubble_graph', {
        ...
        title: {
            text: 'Promedio ' + materia +' vs Índice Socioeconómico de cada Provincia del Ecuador'
        },

        subtitle: {
            text: 'Source: <a href="http://www.evaluacion.gob.ec/evaluaciones/descarga-de-datos/">Instituto Nacional de Evaluacion Educativa</a>'
        },
        ...
        tooltip: {
            ...
            pointFormat: '<tr><th colspan="2"><h3>{point.country}</h3></th></tr>' +
                ...
                '<tr><th>Índice Socioeconómico:</th><td>{point.y}</td></tr>' +
                '<tr><th>Número de Estudiantes:</th><td>{point.z}</td></tr>',
            footerFormat: '</table>',
            followPointer: true
        },
    ...
    for (var key in data){
      ...
      if (key.toLowerCase() == provincia.toLowerCase()){
        ...
        clase_ic = ""
        ic_value = prov["Indice_socioeconomico"];
        if (ic_value <= -1.057){
          clase_ic = "Bajo"
        } else if (ic_value > -1.057 && ic_value <= 0.445){
          clase_ic = "Medio Bajo"
        }  else if (ic_value > 0.445 && ic_value <= 1.292){
          clase_ic = "Medio"
        }  else if (ic_value > 1.292 && ic_value <= 2.154){
          clase_ic = "Medio Alto"
        } else {
          clase_ic = "Alto"
        }
